...
interface State extends Record<targetName, string> {
...
type targetName = 'loginPassword' | 'loginUsername' | 'signupPassword' | 'signupUsername' | 'signupPasswordConfirm';
